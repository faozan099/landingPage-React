...
import "../../css/LandingPageTeamProject/KategoriKecantikan.css";
import axios from "axios";
import star from "../../img/Union.svg";
import ClipLoader from "react-spinners/ClipLoader";

function KategoriKecantikan() {
  const [data, setData] = useState([]);
  const [category, setCategory] = useState("kecantikan");
...
export default KategoriKecantikan;
